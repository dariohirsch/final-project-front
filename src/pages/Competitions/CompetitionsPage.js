		...
		<>
			<div className=" competitionsContainer">
				<Link to={`/competitions/${franceId}`}>
					<img class="fotosLigas" src={league1} alt="league1"></img>
				</Link>

				<Link to={`/competitions/${spainId}`}>
					<img class="fotosLigas" src={laliga} alt="laLiga"></img>
				</Link>

				<Link to={`/competitions/${italyId}`}>
					<img class="fotosLigas" src={seriea} alt="seriaA"></img>
				</Link>

				<Link to={`/competitions/${englandId}`}>
					<img class="fotosLigas" src={premier} alt="premier-league"></img>
				</Link>

				<Link to={`/competitions/${germanyId}`}>
					<img class="fotosLigas" src={bundesleague} alt="bundensliga"></img>
				</Link>
			</div>
		</>
	)
